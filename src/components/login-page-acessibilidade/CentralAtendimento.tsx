      ...
      <div className="bg-white max-w-7xl mx-auto rounded-lg shadow-lg p-8 mt-8">
        ...
        <header className="text-center">
          ...
          <p className="text-cyan-600">
            Estamos aqui para te ajudar. Entre em contato com a nossa equipe de
            suporte!
          </p>
        </header>
        ...
        <section className="mt-8">
          <h2 className="text-2xl text-cyan-800 font-semibold mb-4">
            Entre em Contato
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-cyan-600 text-white p-6 rounded-lg shadow">
              ...
              <p>
                Ligue para nosso atendimento: <strong>0800-123-456</strong>
              </p>
            ...
            <div className="bg-cyan-600 text-white p-6 rounded-lg shadow">
              ...
              <p>
                Envie-nos um e-mail para: <strong>suporte@corretora.com</strong>
              </p>
          ...
          <div className="space-y-4">
            <div className="bg-white border border-cyan-300 p-4 rounded-lg shadow">
              ...
              <p className="mt-2 text-cyan-600">
                Você pode alterar seus dados diretamente no painel de controle
                da sua conta, ou entrar em contato com nosso suporte via
                telefone ou e-mail.
              </p>
            </div>
            <div className="bg-white border border-cyan-300 p-4 rounded-lg shadow">
              ...
              <p className="mt-2 text-cyan-600">
                Nosso atendimento funciona de segunda a sexta, das 08:00 às
                18:00.
              </p>
            </div>
            <div className="bg-white border border-cyan-300 p-4 rounded-lg shadow">
              ...
              <p className="mt-2 text-cyan-600">
                Você pode solicitar a recuperação de senha na página de login,
                clicando em "Esqueci minha senha".
              </p>
            </div>
          </div>
        </section>
