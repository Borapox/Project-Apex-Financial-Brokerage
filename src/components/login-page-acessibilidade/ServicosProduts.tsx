      ...
      <div className="bg-white max-w-7xl mx-auto rounded-lg shadow-lg p-8 mt-8">
        ...
        <header className="text-center">
          ...
          <p className="text-cyan-600">
            Conheça os produtos e serviços que oferecemos para ajudá-lo a
            investir melhor.
          </p>
        </header>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-cyan-600 text-white p-6 rounded-lg shadow">
              ...
              <ul className="list-disc ml-6 mt-2">
                ...
                <li>
                  LCIs e LCAs (Letras de Crédito Imobiliário e Agronegócio)
                </li>
                <li>Debêntures</li>
        ...
        <section className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-cyan-600 text-white p-6 rounded-lg shadow">
              ...
              <p>
                Aprenda a investir de maneira inteligente com nossos cursos e
                webinars ao vivo.
              </p>
            </div>
            <div className="bg-cyan-600 text-white p-6 rounded-lg shadow">
              ...
              <p>
                Conte com uma central de ajuda completa para tirar suas dúvidas
