...
const AdressInfo: React.FC<AdressInfoProps> = ({
  adressData,
  setAdressData,
}) => {
    ...
    <div className="p-4">
      ...
      <div className="flex gap-4 mb-5">
        <input
          ...
          onChange={(e) =>
            setAdressData({ ...adressData, cep: e.target.value })
          } // Atualiza o estado 'adressData' com o valor digitado
        />
        <button
      ...
      {cep && (
        <main className="flex flex-col gap-2">
          ...
          <div className="flex space-x-4">
            <div className="p-3 border bg-white border-cyan-400 rounded-md shadow-md flex-1 flex items-center">
              <p className="font-bold text-md text-cyan-600 uppercase">
                Logradouro:
              </p>
            ...
            <div className="p-3 border bg-white border-cyan-400 rounded-md shadow-md flex-1 flex items-center">
              ...
              {/* Mostra 'N/A' caso não haja complemento */}
            </div>
          </div>
